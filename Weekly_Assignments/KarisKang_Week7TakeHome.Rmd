...
author: Karis Kang and Prof Fisk
---
...
__Answer 1: Factor data is a type of categorical data where there are a set number of character values data can be grouped in e.g. Pokemon types are factor data ("Grass", "Fire", "Psychic")__
...
__Answer 2: mtry =31 had the best accuracy at 0.9616997__
...
__Answer 3: Benign (B) lesions were more likely to be misclassified as malignant (M), than malignant as benign; aka, Type I error__
...
__Answer 4:In the case of cancer diagnosis, Type I errors are preferable if error is present; better to scare someone with a misdiagnosis of malignancy that turns out to be benign, rather than miss a malignant tumor__
...
__Answer 5: If the model were to guess at random, there would be a 50:50 chance of getting the prediction correct aka accuracy = 0.50__
...
__Answer 6: I did this assignment very late, and I wish I hadn't so that I could have spent more time exploring the code - it's interesting to see the modeling tools that are out there even if I don't fully understand them, and get a feel for how different models takes different snapshots of the data to create predictions.__
